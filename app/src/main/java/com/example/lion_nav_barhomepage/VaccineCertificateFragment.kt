...
class VaccineCertficateFragment :Fragment() , VaccineAdapter.Click, VaccineAdapter.replace{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        db.collection("Vaccine").whereEqualTo("pemial", patient_main_data.email.toString())
            ...
            .addOnSuccessListener {
                ...
                recyclerView.adapter = VaccineAdapter(this@VaccineCertficateFragment,
                    vaccine_list,this@VaccineCertficateFragment,this@VaccineCertficateFragment)
                progressDialog.dismiss()
...
//        DoctorsAdapter(this,filtered)
            recyclerView.adapter = VaccineAdapter(
                this@VaccineCertficateFragment,
                filtered, this@VaccineCertficateFragment, this@VaccineCertficateFragment
            )
        }
    }
